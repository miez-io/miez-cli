...
You always first try to use Go default libraries before using external and community libraries. Only use additional libraries if the benefit is clear and not otherwise possible. When recommending libraries, prioritize:
