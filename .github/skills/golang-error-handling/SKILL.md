...
description: "Idiomatic Golang error handling — creation, wrapping with %w, errors.Is/As, errors.Join, custom error types, sentinel errors, panic/recover, the single handling rule, and structured logging with slog. Apply when creating, wrapping, inspecting, or logging errors in Go code."
user-invocable: true
license: MIT
